...
ThemeData lightMode = ThemeData(
  ...
  textTheme: TextTheme(
    ...
    headlineSmall: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold, color: Colors.grey.shade900),
    ...
    labelLarge: TextStyle(fontSize: 22.0, fontWeight: FontWeight.bold, color: Colors.grey.shade500),
    labelMedium: TextStyle(fontSize: 18.0, fontWeight: FontWeight.normal, color: Colors.grey.shade500),
    labelSmall: TextStyle(fontSize: 12.0, fontWeight: FontWeight.normal, color: Colors.grey.shade500),
  ),
);
...
ThemeData darkMode = ThemeData(
  ...
  textTheme: TextTheme(
    ...
    headlineSmall: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold, color: Colors.grey.shade200),
    ...
    labelMedium: TextStyle(fontSize: 18.0, fontWeight: FontWeight.normal, color: Colors.grey.shade600),
    labelSmall: TextStyle(fontSize: 12.0, fontWeight: FontWeight.normal, color: Colors.grey.shade600),
  ),
);
